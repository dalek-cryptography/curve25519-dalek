...
#![no_std]
#![cfg_attr(all(curve25519_dalek_backend = "simd", target_arch = "x86_64", nightly), feature(stdsimd))]
#![cfg_attr(all(curve25519_dalek_backend = "simd", target_arch = "x86_64", nightly), feature(avx512_target_feature))]
