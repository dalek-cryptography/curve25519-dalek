...
/// Limb cosntants pre-computed with \\(\mathcal E[4]\\).
pub const EIGHT_TORSION_PRECOMP: [EdwardsPoint; 3] = EIGHT_TORSION_PRECOMP_INNER_DOC_HIDDEN;
...
/// Inner item used to hide limb constants from cargo doc output.
#[doc(hidden)]
pub const EIGHT_TORSION_PRECOMP_INNER_DOC_HIDDEN: [EdwardsPoint; 3] = [
EdwardsPoint {
        X: FieldElement51([1705902058477384, 1500091386304416, 58513091555839, 430710997322448, 1153356343230368]),
        Y: FieldElement51([982979850450540, 1443838881490495, 1212579692235915, 279328407072287, 1520186804474639]),
        Z: FieldElement51([2251799813685233, 2251799813685247, 2251799813685247, 2251799813685247, 2251799813685247]),
        T: FieldElement51([1641783077407016, 2186204229749008, 1479702903584263, 902914522669878, 1722008015084834])
}, EdwardsPoint {
        X: FieldElement51([2052228846758770, 2169805333764948, 723728722637705, 2743246494724, 2152510018856043]),
        Y: FieldElement51([1801439850948180, 1351079888211148, 450359962737049, 900719925474099, 1801439850948198]),
        Z: FieldElement51([2251799813685233, 2251799813685247, 2251799813685247, 2251799813685247, 2251799813685247]),
        T: FieldElement51([610016736278213, 65595583936239, 772096910100984, 1348885291015369, 529791798600413])
}, EdwardsPoint {
        X: FieldElement51([545897755207845, 751708427380831, 2193286722129408, 1821088816362799, 1098443470454879]),
        Y: FieldElement51([1268819963234689, 807960932194752, 1039220121449332, 1972471406612960, 731613009210608]),
        Z: FieldElement51([2251799813685233, 2251799813685247, 2251799813685247, 2251799813685247, 2251799813685247]),
        T: FieldElement51([1641783077407016, 2186204229749008, 1479702903584263, 902914522669878, 1722008015084834])
}];
