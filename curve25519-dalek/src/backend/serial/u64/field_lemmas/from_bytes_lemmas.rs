...
pub proof fn as_nat_32_mod_255(bytes: &[u8; 32])
    ensures
        as_nat_32_u8(bytes) % pow2(255)
        ==
        (bytes[ 0] * pow2( 0 * 8)) +
        (bytes[ 1] * pow2( 1 * 8)) +
        (bytes[ 2] * pow2( 2 * 8)) +
        ...
        (bytes[29] * pow2(29 * 8)) +
        (bytes[30] * pow2(30 * 8)) +
        ((bytes[31] as nat % pow2(7)) * pow2(31 * 8))
{
    assert(
        as_nat_32_u8(bytes)
        ==
        ...
        (bytes[31] * pow2(31 * 8))
        ==
        pow2_sum(bytes, 0, 8, 30) +  (bytes[31] * pow2(31 * 8))
    ) by {
        assert(pow2(0) == 1) by {
            lemma2_to64();
        }
    ...
    assert(
        as_nat_32_u8(bytes) % pow2(255)
        ==
        (pow2_sum(bytes, 0, 8, 30) + bytes[31] * pow2(31 * 8)) as nat % pow2(255)
    );
    ...
    assert(
        ...
        assert(
            (pow2_sum(bytes, 0, 8, 30) + bytes[31] * pow2(31 * 8)) as nat % pow2(255)
            ==
            pow2_sum(bytes, 0, 8, 30) % pow2(255) + (bytes[31] * pow2(31 * 8)) as nat % pow2(255)
        ) by {
    ...
    assert(
        (bytes[31] as nat * pow2(31 * 8)) % pow2(255)
        ==
        ((bytes[31] as nat % pow2(7)) * pow2(31 * 8))
    ) by {
