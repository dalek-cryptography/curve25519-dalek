...
//! $$
//! In `curve25519-elligator2`, this is represented as the `CompletedPoint`
//! struct.
...
//! and Dawson.  In `curve25519-elligator2`, it is represented as the
...
//! Birkner, Joye, Lange, and Peters.  In `curve25519-elligator2`, it is
...
//! `curve25519-elligator2` was originally derived from.
//!
