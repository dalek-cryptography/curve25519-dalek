...
cfg_if! {
    if #[cfg(curve25519_dalek_backend = "fiat")] {
        pub(crate) use crate::backend::serial::fiat_u32::field::FieldElement2625;
        ...
        pub(crate) use crate::backend::serial::u32::field::FieldElement2625;
...
pub(crate) const SQRT_ID: FieldElement2625 = field_element([
...
pub(crate) const DP1_OVER_DM1: FieldElement2625 = field_element([
...
pub(crate) const MDOUBLE_INVSQRT_A_MINUS_D: FieldElement2625 = field_element([
...
/// and `i = +sqrt(-1)`.
pub(crate) const MIDOUBLE_INVSQRT_A_MINUS_D: FieldElement2625 = field_element([
...
pub(crate) const MINVSQRT_ONE_PLUS_D: FieldElement2625 = field_element([
