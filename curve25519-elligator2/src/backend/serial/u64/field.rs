...
/// # Note
///
/// The `curve25519_elligator2::field` module provides a type alias
/// `curve25519_elligator2::field::FieldElement` to either `FieldElement51`
/// or `FieldElement2625`.
///
/// The backend-specific type `FieldElement51` should not be used
/// outside of the `curve25519_elligator2::field` module.
#[derive(Copy, Clone)]
