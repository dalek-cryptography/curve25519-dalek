...
mod multiscalar_benches {
    ...
    use curve25519_elligator2::edwards::EdwardsPoint;
    use curve25519_elligator2::edwards::VartimeEdwardsPrecomputation;
    use curve25519_elligator2::traits::MultiscalarMul;
    use curve25519_elligator2::traits::VartimeMultiscalarMul;
    use curve25519_elligator2::traits::VartimePrecomputedMultiscalarMul;
...
mod ristretto_benches {
    use super::*;
    use curve25519_elligator2::ristretto::RistrettoPoint;
