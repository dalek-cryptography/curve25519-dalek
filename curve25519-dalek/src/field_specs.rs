...
pub open spec fn field_element_as_bytes(fe: &FieldElement51) -> Seq<u8> {
    ...
    Seq::new(32, |i: int| 
        if i == 0 {   limbs0_canon                                 as u8 }
        else if i == 1 {  (limbs0_canon >>  8)                     as u8 }
        else if i == 2 {  (limbs0_canon >> 16)                     as u8 }
        else if i == 3 {  (limbs0_canon >> 24)                     as u8 }
        else if i == 4 {  (limbs0_canon >> 32)                     as u8 }
        else if i == 5 {  (limbs0_canon >> 40)                     as u8 }
        else if i == 6 { ((limbs0_canon >> 48) | (limbs1_canon << 3)) as u8 }
        else if i == 7 {  (limbs1_canon >>  5)                     as u8 }
        else if i == 8 {  (limbs1_canon >> 13)                     as u8 }
        else if i == 9 {  (limbs1_canon >> 21)                     as u8 }
        else if i == 10 {  (limbs1_canon >> 29)                     as u8 }
        else if i == 11 {  (limbs1_canon >> 37)                     as u8 }
        else if i == 12 { ((limbs1_canon >> 45) | (limbs2_canon << 6)) as u8 }
        else if i == 13 {  (limbs2_canon >>  2)                     as u8 }
        else if i == 14 {  (limbs2_canon >> 10)                     as u8 }
        else if i == 15 {  (limbs2_canon >> 18)                     as u8 }
        else if i == 16 {  (limbs2_canon >> 26)                     as u8 }
        else if i == 17 {  (limbs2_canon >> 34)                     as u8 }
        else if i == 18 {  (limbs2_canon >> 42)                     as u8 }
        else if i == 19 { ((limbs2_canon >> 50) | (limbs3_canon << 1)) as u8 }
        else if i == 20 {  (limbs3_canon >>  7)                     as u8 }
        else if i == 21 {  (limbs3_canon >> 15)                     as u8 }
        else if i == 22 {  (limbs3_canon >> 23)                     as u8 }
        else if i == 23 {  (limbs3_canon >> 31)                     as u8 }
        else if i == 24 {  (limbs3_canon >> 39)                     as u8 }
        else if i == 25 { ((limbs3_canon >> 47) | (limbs4_canon << 4)) as u8 }
        else if i == 26 {  (limbs4_canon >>  4)                     as u8 }
        else if i == 27 {  (limbs4_canon >> 12)                     as u8 }
        else if i == 28 {  (limbs4_canon >> 20)                     as u8 }
        else if i == 29 {  (limbs4_canon >> 28)                     as u8 }
        else if i == 30 {  (limbs4_canon >> 36)                     as u8 }
        else /* i == 31 */ {  (limbs4_canon >> 44)                     as u8 }
    )
}
